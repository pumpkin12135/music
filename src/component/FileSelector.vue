<template>
  <el-upload :auto-upload="false" :on-change="addFile" :show-file-list="false" action="" drag multiple>
    <img v-show="!progress_show" src="../../public/img/upload.png" style="margin:30px 0px 16px">
    <div v-show="!progress_show" class="el-upload__text">将文件拖到此处，或 <em>点击选择</em></div>
    <!--工作模式-->
    ...
    <transition name="el-fade-in"
      ...
      <el-progress
        ...
        :stroke-width="16"
        :text-inside="true"
        style="margin: 90px 100px 0 100px"
      ></el-progress>
    </transition>
  </el-upload>
</template>
