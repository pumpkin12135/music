    ...
    <div id="app-control">
      ...
      <el-row>
        ...
        <el-tooltip class="item" effect="dark" placement="top">
          ...
          <el-button icon="el-icon-s-tools" plain type="warning" @click="showConfigDialog = true">解密设定</el-button>
        </el-tooltip>
        <el-button icon="el-icon-download" plain type="success" @click="handleDownloadAll">下载全部</el-button>
